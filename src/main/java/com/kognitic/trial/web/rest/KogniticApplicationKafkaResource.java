...
@RestController
@RequestMapping("/api/kognitic-application-kafka")
public class KogniticApplicationKafkaResource {
    private final Logger log = LoggerFactory.getLogger(KogniticApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public KogniticApplicationKafkaResource(KafkaProperties kafkaProperties) {
